...
public class ApplicationCategoryService implements ApplicationCategoryInputPort {
    ...
    @Override
    public SharedCategoryResponse createCategory(SharedCreateCategoryRequest request) throws ApplicationExceptionCategory {
    ...
    @Override
    public List<SharedCategoryResponse> getCategories(SharedCategoryFilterCriteria filter) throws ApplicationExceptionCategory {
        List<DomainEntityCategory> categories = categoryRepository.findAll(filter);
        return categoryMapper.toDTOList(categories);
    }

    @Override
    public SharedCategoryResponse getCategoryById(UUID categoryId) throws ApplicationExceptionCategory {
    ...
    @Override
    public SharedCategoryResponse updateCategory(UUID categoryId, SharedUpdateCategoryRequest request) throws ApplicationExceptionCategory {
        validateRequest(request);
    ...
    @Override
    public void deleteCategory(UUID categoryId, boolean cascade) throws ApplicationExceptionCategory {
        DomainEntityCategory category = categoryRepository.findById(categoryId)
                .orElseThrow(() -> new ApplicationExceptionCategory("Category not found.", 404));
    ...
    private void validateRequest(Object request) throws ConstraintViolationException {
