...
import ai.shreds.shared.ValidCategoryParentAnnotation;
...
public class ValidCategoryParentValidator implements ConstraintValidator<ValidCategoryParentAnnotation, SharedCreateCategoryRequest> {

    private final DomainServiceCategoryManager categoryManager;

    @Override
    public void initialize(ValidCategoryParentAnnotation constraintAnnotation) {
